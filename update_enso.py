...
<div style="max-width:560px;margin:auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.1)">
  ...
  <div style="padding:20px 24px">
    ...
    <div style="display:flex;gap:10px;margin-top:16px;flex-wrap:wrap">
      ...
      <a href="{pages_url}research.html" style="display:inline-block;background:#1c2128;color:#c9d1d9;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:600;font-size:.9rem;border:1px solid #30363d">
